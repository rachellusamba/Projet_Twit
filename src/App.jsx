...
function App() { 
  ...
  return (
    <div className='flex ml-60 mx-auto'>
      <div className="w-full lg:w-2/12 ">
        <div className='fixed left-0 top-1 right-0 w-2/12 ml-60'>
          ...
          <div className='pt-10'>
            <Button className='bg-blue-400 text-white w-48 h-12 rounded-3xl' text="Post" />
          </div>
      ...
      <div className="w-full lg:w-5/12 border border-slate-800 ml-2 ">
        <Routes>
          <Route path='/' element={<Home />} />
          <Route path='/Profil' element={<Profil />} />
        </Routes>
      </div>
      <div className="w-full lg:w-3/12 pl-4 mt-1 ">
